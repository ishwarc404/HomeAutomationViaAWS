...
//LDR LIGHT CONTROLLING - D5
const int ldr_ledPin = 14;
const int ldrPin = A0;
...
void setup() {
  ...
  Serial.println("Status\tHumidity (%)\tTemperature (C)\t(F)");
   dht.setup(16, DHTesp::DHT11); //attached to D0
...
void loop() {
  ...
  client.println("<br><br>");
  client.print("DOOR CONTROL: ");
   client.println("<br><br>");
  client.println("<a href=\"/DOOR=OPEN\"\"><button>DOOR OPEN </button></a>");
  client.println("<a href=\"/DOOR=CLOSE\"\"><button>DOOR CLOSE </button></a><br />");  
  client.println("</html>");
